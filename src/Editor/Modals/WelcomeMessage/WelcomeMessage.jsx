...
class WelcomeModal extends Component {
  constructor () {
    ...
    let t4 = ["Golan Levin", "Daniel Sun", "Benjamin Briand", "Joseph Hocking", "Charisse Hampton", "Jessie Young", "Bluecake", "O.K. Keyes", "Sarksus", "Laurens Bonnema", "Supersatanson", "Arturo Andreu Villalba", "Anonymous"]
    let t5 = ["Joe", "Karlin Fox", "StepSwitcher", "Ann Griffin", "Happyships", "Dixie Dorward", "Albin Rodriguex", "Loren Rosser", "Brent Knopf", "Uhlmann", "Lisa McBride", "Lana Storto", "Justin James"]
