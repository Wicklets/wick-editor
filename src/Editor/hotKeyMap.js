...
class HotKeyInterface extends Object {
  ...
  createHandlers() {
    this.handlers = {
      ...
      'delete': (() =>  this.editor.state.selection.deleteSelectedObjects()),
      'preview-play-toggle': (() => this.editor.togglePreviewPlaying()),
      'convert-to-symbol': (() => this.editor.openModal('ConvertToSymbol')),
      'edit-selection': (() => this.editor.state.selection.focusSelectedObject()),
      'edit-parent': (() => this.editor.state.selection.focusParentObject()),
