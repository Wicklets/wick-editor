...
Wick.GUIElement = class {
  ...
  Wick.GUIElement.WICK_GREEN = '#1EE29A'; //basic colors
  Wick.GUIElement.WICK_GREEN_MEDIUM = '#1EE29A';
  Wick.GUIElement.WICK_GREEN_DARK = '#1EE29A';
  Wick.GUIElement.WICK_RED = '#FF5C5C';
  
  Wick.GUIElement.GRID_DEFAULT_CELL_WIDTH = 24;
  ...
  Wick.GUIElement.NUMBER_LINE_NUMBERS_COMMON_COLOR = '#666';
  Wick.GUIElement.NUMBER_LINE_NUMBERS_FONT_FAMILY = 'Ubuntu Condensed'; //condensed to avoid overflow of larger numbers
  ...
  Wick.GUIElement.FRAME_CONTENT_DOT_STROKE = 'rgb(24,180,105)';
  Wick.GUIElement.FRAME_CONTENT_DOT_FILL = '#1EE29A';
  ...
  Wick.GUIElement.PLAYHEAD_FILL_COLOR = Wick.GUIElement.WICK_RED;
  Wick.GUIElement.PLAYHEAD_STROKE_COLOR = '#AAAAAA';
  Wick.GUIElement.PLAYHEAD_STROKE_WIDTH = 3;
  Wick.GUIElement.PLAYHEAD_MARGIN = 7;

  Wick.GUIElement.LAYER_LABEL_ACTIVE_FILL_COLOR = Wick.GUIElement.WICK_GREEN;
  ...
  Wick.GUIElement.LAYER_LABEL_ACTIVE_FONT_COLOR = '#000';
  Wick.GUIElement.LAYER_LABEL_INACTIVE_FONT_COLOR = '#020604';
  Wick.GUIElement.LAYER_LABEL_FONT_WEIGHT = '300';
  ...
  Wick.GUIElement.LAYER_BUTTON_ICON_OPACITY = 0.5;
